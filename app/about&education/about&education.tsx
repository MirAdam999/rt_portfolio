        ...
        <div className='about-education-wrapper'>
            <div className='about'>
                ...
                <p className={fine_font.className} id='about-txt'>
                    It all began in my childhood years with the discovery of Visual Basic - and from there, the spark never faded.
                    After several years working in healthcare, I decided to return to my true passion: programming.
                    I’m a lifelong learner who thrives in agile environments and enjoys exploring modern technologies.
